...
const roadmap: { title: string; status: Status; note: string }[] = [
  ...
  },
  {
    ...
    status: "shipped",
    note: "Done: the gated Studio editor, the AI writing assistant + tag suggester, on-brand cover generation (gpt-image-1), and the Content engine that batch-writes a week of posts. Still outstanding: re-hosting the ~65 migrated back-catalogue covers into OO storage (the engine only covers newly generated posts), and the newsletter (built in blog-assistant, surfaces in Phase 4).",
  },
  {
